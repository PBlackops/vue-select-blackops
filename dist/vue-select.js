...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".v-select-wrap{position:relative}.v-select-wrap .open-indicator{position:absolute;top:50%;right:.875rem;margin-top:-.5rem;display:inline-block;cursor:pointer;pointer-events:all;-webkit-transition:all .15s cubic-bezier(1,-.115,.975,.855);transition:all .15s cubic-bezier(1,-.115,.975,.855);-webkit-transition-timing-function:cubic-bezier(1,-.115,.975,.855);transition-timing-function:cubic-bezier(1,-.115,.975,.855);opacity:1;-webkit-transition:opacity .1s;transition:opacity .1s}.v-select-wrap.loading .open-indicator{opacity:0}.v-select-wrap .open-indicator:before{content:\"\\F0D8\";vertical-align:top;display:inline-block;font:normal normal normal 14px/1 FontAwesome;font-size:inherit;text-rendering:auto;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;-webkit-transform:rotate(180deg);transform:rotate(180deg);-webkit-transition:all .15s cubic-bezier(1,-.115,.975,.855);transition:all .15s cubic-bezier(1,-.115,.975,.855);-webkit-transition-timing-function:cubic-bezier(1,-.115,.975,.855);transition-timing-function:cubic-bezier(1,-.115,.975,.855)}.v-select-wrap.open .open-indicator{bottom:1px}.v-select-wrap.open .open-indicator:before{-webkit-transform:rotate(1turn);transform:rotate(1turn)}.v-select-wrap .dropdown-toggle{display:block;width:100%;padding:.5rem .75rem;font-size:1rem;line-height:1.25;min-height:2.5rem;color:#55595c;background-color:#fff;background-image:none;background-clip:padding-box;border:1px solid rgba(0,0,0,.15);border-radius:0;-webkit-appearance:none}.v-select-wrap .dropdown-toggle:after{display:unset;margin-left:0;content:\"\";border-top:0;border-left:0;border-right:0}.v-select-wrap.searchable .dropdown-toggle{cursor:text}.v-select-wrap.open .dropdown-toggle{border-bottom:none;border-bottom-left-radius:0;border-bottom-right-radius:0}.v-select-wrap>.dropdown-menu{margin:0;width:100%;overflow-y:scroll;border-top:none;border-top-left-radius:0;border-top-right-radius:0}.v-select-wrap>.dropdown-menu li.active{background:#1a1a1a;color:#fff}.v-select-wrap>.dropdown-menu li a{display:block;padding:.25rem .5rem}.v-select .selected-tag{color:#000;float:left;font-size:16px}.v-select .multiple-selected-lbl-wrap:before{content:\"Vendors Added\";display:inline-block;margin:1rem 0 .5rem;font-weight:700}.v-select .multiple-selected-tag-wrap{padding:1rem 0}.v-select .multiple-selected-tag{display:block;padding:.5rem .75rem;margin-bottom:1rem;border:1px solid #d0d0d0;background:#e1e1e1;color:#505050}.v-select .multiple-selected-tag .close{opacity:1;color:#b40000;line-height:.75}.v-select input[type=search],.v-select input[type=search]:focus{display:inline-block;border:none;outline:none;margin:0;padding:0 .5em;width:10em;max-width:100%;background:none;position:relative;box-shadow:none;float:left;clear:none}.v-select input[type=search]:disabled,.v-select li a{cursor:pointer}.v-select .active a{background:#005a2c;color:#fff}.v-select .highlight a,.v-select li:hover>a:hover{background:#e1e1e1;color:#000}.v-select .spinner{opacity:0;position:absolute;top:5px;right:10px;font-size:5px;text-indent:-9999em;overflow:hidden;border-top:.9em solid hsla(0,0%,39%,.1);border-right:.9em solid hsla(0,0%,39%,.1);border-bottom:.9em solid hsla(0,0%,39%,.1);border-left:.9em solid rgba(60,60,60,.45);-webkit-transform:translateZ(0);transform:translateZ(0);-webkit-animation:vSelectSpinner 1.1s infinite linear;animation:vSelectSpinner 1.1s infinite linear;-webkit-transition:opacity .1s;transition:opacity .1s}.v-select.loading .spinner{opacity:1}.v-select .spinner,.v-select .spinner:after{border-radius:50%;width:5em;height:5em}@-webkit-keyframes vSelectSpinner{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}@keyframes vSelectSpinner{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = " <div class=\"dropdown v-select\"> <div class=v-select-wrap :class=dropdownClasses> <div v-el:toggle @mousedown.prevent=toggleDropdown class=\"dropdown-toggle clearfix\" type=button> <span class=form-control v-if=\"!searchable && isValueEmpty\">{{ placeholder }}</span> <span v-if=!multiple> <span class=selected-tag v-for=\"option in valueAsArray\" track-by=$index>{{ getOptionLabel(option) }}</span> </span> <input v-el:search :debounce=debounce v-model=search v-show=searchable @keydown.delete=maybeDeleteValue @keyup.esc=onEscape @keydown.up.prevent=typeAheadUp @keydown.down.prevent=typeAheadDown @keyup.enter.prevent=typeAheadSelect @blur=\"open = false\" @focus=\"open = true\" type=search class=form-control :placeholder=searchPlaceholder :style=\"{ width: isValueEmpty ? '100%' : 'auto' }\"> <i v-el:open-indicator role=presentation class=open-indicator></i> <slot name=spinner> <div class=spinner v-show=loading>Loading...</div> </slot> </div> <ul v-el:dropdown-menu v-show=open :transition=transition class=dropdown-menu :style=\"{ 'max-height': maxHeight }\"> <li v-for=\"option in filteredOptions\" track-by=$index :class=\"{ active: isOptionSelected(option), highlight: $index === typeAheadPointer }\" @mouseover=\"typeAheadPointer = $index\"> <a @mousedown.prevent=select(option)> {{ getOptionLabel(option) }} </a> </li> <li transition=fade v-if=!filteredOptions.length class=divider></li> <li transition=fade v-if=!filteredOptions.length class=text-center> <slot name=no-options>Sorry, no matching options.</slot> </li> </ul> </div> <div class=multiple-selected-tag-wrap v-if=multiple v-bind:class=\"{'multiple-selected-lbl-wrap' : valueAsArray != null}\" track-by=$index> <span class=\"multiple-selected-tag clearfix\" v-for=\"option in valueAsArray\" track-by=$index> {{ getOptionLabel(option) }} <button @click=select(option) type=button class=close><span aria-hidden=true>&times;</span></button> </span> </div> </div> ";
